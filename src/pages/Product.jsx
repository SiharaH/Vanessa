    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col md:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <h1 className='font-medium text-2xl mt-5'>LKR {productData.price}</h1>
          ...
          <button className='bg-black text-white py-2 px-4 hover:bg-pink-600 transition-all ease-in duration-200'>Add to Cart</button>
